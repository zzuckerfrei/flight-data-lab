...
![데이터 흐름 아키텍처](docs/images/flight-data-lab-01.png)
...
![인프라 아키텍처](docs/images/flight-data-lab-02.png)
...
분쟁지역의 영공 회피가 밀도 공백으로 나타난다(특히 우크라이나에서 뚜렷하다).

> **한계**: OpenSky는 자원봉사자·연구기관·기업이 운영하는 지상 ADS-B 수신기 네트워크라 커버리지가 지역마다 고르지 않다(유럽·북미 조밀, 그 밖 성김). 따라서 지역 간 밀도는 절대 수치보다 **방향성**으로 읽어야 하며, 유럽에 인접한 우크라이나의 공백이 가장 신뢰할 만하다.
